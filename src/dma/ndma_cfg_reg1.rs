#[doc = "Register `NDMA_CFG_REG1` reader"]
pub type R = crate::R<NdmaCfgReg1Spec>;
#[doc = "Register `NDMA_CFG_REG1` writer"]
pub type W = crate::W<NdmaCfgReg1Spec>;
...
#[doc = "Field `DMA_LOADING` reader - DMA Loading. Set 1 to start, auto-cleared when finished."]
pub type DmaLoadingR = crate::BitReader;
#[doc = "Field `DMA_LOADING` writer - DMA Loading. Set 1 to start, auto-cleared when finished."]
...
impl R {
    ...
    #[doc = "Bit 31 - DMA Loading. Set 1 to start, auto-cleared when finished."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:4 - Source DRQ Type"]
    #[inline(always)]
    pub fn src_drq_type(&mut self) -> SrcDrqTypeW<'_, NdmaCfgReg1Spec> {
        SrcDrqTypeW::new(self, 0)
    }
    #[doc = "Bits 5:6 - Source Address Type. 00=Linear, 01=IO"]
    #[inline(always)]
    pub fn src_addr_type(&mut self) -> SrcAddrTypeW<'_, NdmaCfgReg1Spec> {
        SrcAddrTypeW::new(self, 5)
    }
    #[doc = "Bit 7 - Source Burst Length. 0=1, 1=4"]
    #[inline(always)]
    pub fn src_burst_len(&mut self) -> SrcBurstLenW<'_, NdmaCfgReg1Spec> {
        SrcBurstLenW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Source Data Width. 00=8-bit, 01=16-bit, 10=32-bit"]
    #[inline(always)]
    pub fn src_data_width(&mut self) -> SrcDataWidthW<'_, NdmaCfgReg1Spec> {
        SrcDataWidthW::new(self, 8)
    }
    #[doc = "Bit 15 - Remain byte counter read enable"]
    #[inline(always)]
    pub fn remain_byte_read_en(&mut self) -> RemainByteReadEnW<'_, NdmaCfgReg1Spec> {
        RemainByteReadEnW::new(self, 15)
    }
    #[doc = "Bits 16:20 - Destination DRQ Type"]
    #[inline(always)]
    pub fn dst_drq_type(&mut self) -> DstDrqTypeW<'_, NdmaCfgReg1Spec> {
        DstDrqTypeW::new(self, 16)
    }
    #[doc = "Bits 21:22 - Destination Address Type. 00=Linear, 01=IO"]
    #[inline(always)]
    pub fn dst_addr_type(&mut self) -> DstAddrTypeW<'_, NdmaCfgReg1Spec> {
        DstAddrTypeW::new(self, 21)
    }
    #[doc = "Bit 23 - Destination Burst Length. 0=1, 1=4"]
    #[inline(always)]
    pub fn dst_burst_len(&mut self) -> DstBurstLenW<'_, NdmaCfgReg1Spec> {
        DstBurstLenW::new(self, 23)
    }
    #[doc = "Bits 24:25 - Destination Data Width. 00=8-bit, 01=16-bit, 10=32-bit"]
    #[inline(always)]
    pub fn dst_data_width(&mut self) -> DstDataWidthW<'_, NdmaCfgReg1Spec> {
        DstDataWidthW::new(self, 24)
    }
    #[doc = "Bits 26:28 - DMA Wait State"]
    #[inline(always)]
    pub fn dma_wait_state(&mut self) -> DmaWaitStateW<'_, NdmaCfgReg1Spec> {
        DmaWaitStateW::new(self, 26)
    }
    #[doc = "Bit 29 - DMA Continuous Mode Enable. 0=Disable, 1=Enable"]
    #[inline(always)]
    pub fn dma_continuous(&mut self) -> DmaContinuousW<'_, NdmaCfgReg1Spec> {
        DmaContinuousW::new(self, 29)
    }
    #[doc = "Bit 31 - DMA Loading. Set 1 to start, auto-cleared when finished."]
    #[inline(always)]
    pub fn dma_loading(&mut self) -> DmaLoadingW<'_, NdmaCfgReg1Spec> {
        DmaLoadingW::new(self, 31)
    }
}
#[doc = "Normal DMA Channel 1 Configure Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ndma_cfg_reg1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ndma_cfg_reg1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct NdmaCfgReg1Spec;
impl crate::RegisterSpec for NdmaCfgReg1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ndma_cfg_reg1::R`](R) reader structure"]
impl crate::Readable for NdmaCfgReg1Spec {}
#[doc = "`write(|w| ..)` method takes [`ndma_cfg_reg1::W`](W) writer structure"]
impl crate::Writable for NdmaCfgReg1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets NDMA_CFG_REG1 to value 0"]
impl crate::Resettable for NdmaCfgReg1Spec {}
