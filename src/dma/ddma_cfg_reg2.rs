#[doc = "Register `DDMA_CFG_REG2` reader"]
pub type R = crate::R<DdmaCfgReg2Spec>;
#[doc = "Register `DDMA_CFG_REG2` writer"]
pub type W = crate::W<DdmaCfgReg2Spec>;
...
impl W {
    #[doc = "Bits 0:4 - Source DRQ Type"]
    #[inline(always)]
    pub fn src_drq_type(&mut self) -> SrcDrqTypeW<'_, DdmaCfgReg2Spec> {
        SrcDrqTypeW::new(self, 0)
    }
    #[doc = "Bits 5:6 - Source Address Mode"]
    #[inline(always)]
    pub fn src_addr_mode(&mut self) -> SrcAddrModeW<'_, DdmaCfgReg2Spec> {
        SrcAddrModeW::new(self, 5)
    }
    #[doc = "Bit 7 - Source Burst Length"]
    #[inline(always)]
    pub fn src_burst_len(&mut self) -> SrcBurstLenW<'_, DdmaCfgReg2Spec> {
        SrcBurstLenW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Source Data Width"]
    #[inline(always)]
    pub fn src_data_width(&mut self) -> SrcDataWidthW<'_, DdmaCfgReg2Spec> {
        SrcDataWidthW::new(self, 8)
    }
    #[doc = "Bit 10 - Source INCR8 enable"]
    #[inline(always)]
    pub fn src_incr8_en(&mut self) -> SrcIncr8EnW<'_, DdmaCfgReg2Spec> {
        SrcIncr8EnW::new(self, 10)
    }
    #[doc = "Bit 15 - Remain byte counter read enable"]
    #[inline(always)]
    pub fn remain_byte_read_en(&mut self) -> RemainByteReadEnW<'_, DdmaCfgReg2Spec> {
        RemainByteReadEnW::new(self, 15)
    }
    #[doc = "Bits 16:20 - Destination DRQ Type"]
    #[inline(always)]
    pub fn dst_drq_type(&mut self) -> DstDrqTypeW<'_, DdmaCfgReg2Spec> {
        DstDrqTypeW::new(self, 16)
    }
    #[doc = "Bits 21:22 - Destination Address Mode"]
    #[inline(always)]
    pub fn dst_addr_mode(&mut self) -> DstAddrModeW<'_, DdmaCfgReg2Spec> {
        DstAddrModeW::new(self, 21)
    }
    #[doc = "Bit 23 - Destination Burst Length"]
    #[inline(always)]
    pub fn dst_burst_len(&mut self) -> DstBurstLenW<'_, DdmaCfgReg2Spec> {
        DstBurstLenW::new(self, 23)
    }
    #[doc = "Bits 24:25 - Destination Data Width"]
    #[inline(always)]
    pub fn dst_data_width(&mut self) -> DstDataWidthW<'_, DdmaCfgReg2Spec> {
        DstDataWidthW::new(self, 24)
    }
    #[doc = "Bit 26 - Destination INCR8 enable"]
    #[inline(always)]
    pub fn dst_incr8_en(&mut self) -> DstIncr8EnW<'_, DdmaCfgReg2Spec> {
        DstIncr8EnW::new(self, 26)
    }
    #[doc = "Bit 29 - DMA Continuous Mode Enable"]
    #[inline(always)]
    pub fn dma_continuous(&mut self) -> DmaContinuousW<'_, DdmaCfgReg2Spec> {
        DmaContinuousW::new(self, 29)
    }
    #[doc = "Bit 31 - DMA Loading"]
    #[inline(always)]
    pub fn dma_loading(&mut self) -> DmaLoadingW<'_, DdmaCfgReg2Spec> {
        DmaLoadingW::new(self, 31)
    }
}
#[doc = "Dedicated DMA Channel 2 Configure Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ddma_cfg_reg2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ddma_cfg_reg2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdmaCfgReg2Spec;
impl crate::RegisterSpec for DdmaCfgReg2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddma_cfg_reg2::R`](R) reader structure"]
impl crate::Readable for DdmaCfgReg2Spec {}
#[doc = "`write(|w| ..)` method takes [`ddma_cfg_reg2::W`](W) writer structure"]
impl crate::Writable for DdmaCfgReg2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DDMA_CFG_REG2 to value 0"]
impl crate::Resettable for DdmaCfgReg2Spec {}
