#[doc = "Register `DDMA_CFG_REG3` reader"]
pub type R = crate::R<DdmaCfgReg3Spec>;
#[doc = "Register `DDMA_CFG_REG3` writer"]
pub type W = crate::W<DdmaCfgReg3Spec>;
...
#[doc = "Field `SRC_INCR8_EN` reader - Source INCR8 enable. 0=Single/INCR4, 1=INCR8"]
pub type SrcIncr8EnR = crate::BitReader;
#[doc = "Field `SRC_INCR8_EN` writer - Source INCR8 enable. 0=Single/INCR4, 1=INCR8"]
...
#[doc = "Field `DST_INCR8_EN` reader - Destination INCR8 enable. 0=Single/INCR4, 1=INCR8"]
pub type DstIncr8EnR = crate::BitReader;
#[doc = "Field `DST_INCR8_EN` writer - Destination INCR8 enable. 0=Single/INCR4, 1=INCR8"]
pub type DstIncr8EnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DMA_MEM_SET_MODE` reader - Memory set mode enable. 0=Disable, 1=Move data from DDMA_GEN_DATA to destination. Source config (bit10-0) invalid when set."]
pub type DmaMemSetModeR = crate::BitReader;
#[doc = "Field `DMA_MEM_SET_MODE` writer - Memory set mode enable. 0=Disable, 1=Move data from DDMA_GEN_DATA to destination. Source config (bit10-0) invalid when set."]
pub type DmaMemSetModeW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 10 - Source INCR8 enable. 0=Single/INCR4, 1=INCR8"]
    #[inline(always)]
    ...
    #[doc = "Bit 26 - Destination INCR8 enable. 0=Single/INCR4, 1=INCR8"]
    #[inline(always)]
    pub fn dst_incr8_en(&self) -> DstIncr8EnR {
        DstIncr8EnR::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 28 - Memory set mode enable. 0=Disable, 1=Move data from DDMA_GEN_DATA to destination. Source config (bit10-0) invalid when set."]
    #[inline(always)]
    pub fn dma_mem_set_mode(&self) -> DmaMemSetModeR {
        DmaMemSetModeR::new(((self.bits >> 28) & 1) != 0)
    }
...
impl W {
    #[doc = "Bits 0:4 - Source DRQ Type"]
    #[inline(always)]
    pub fn src_drq_type(&mut self) -> SrcDrqTypeW<'_, DdmaCfgReg3Spec> {
        SrcDrqTypeW::new(self, 0)
    }
    #[doc = "Bits 5:6 - Source Address Mode"]
    #[inline(always)]
    pub fn src_addr_mode(&mut self) -> SrcAddrModeW<'_, DdmaCfgReg3Spec> {
        SrcAddrModeW::new(self, 5)
    }
    #[doc = "Bit 7 - Source Burst Length"]
    #[inline(always)]
    pub fn src_burst_len(&mut self) -> SrcBurstLenW<'_, DdmaCfgReg3Spec> {
        SrcBurstLenW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Source Data Width"]
    #[inline(always)]
    pub fn src_data_width(&mut self) -> SrcDataWidthW<'_, DdmaCfgReg3Spec> {
        SrcDataWidthW::new(self, 8)
    }
    #[doc = "Bit 10 - Source INCR8 enable. 0=Single/INCR4, 1=INCR8"]
    #[inline(always)]
    pub fn src_incr8_en(&mut self) -> SrcIncr8EnW<'_, DdmaCfgReg3Spec> {
        SrcIncr8EnW::new(self, 10)
    }
    #[doc = "Bit 15 - Remain byte counter read enable"]
    #[inline(always)]
    pub fn remain_byte_read_en(&mut self) -> RemainByteReadEnW<'_, DdmaCfgReg3Spec> {
        RemainByteReadEnW::new(self, 15)
    }
    #[doc = "Bits 16:20 - Destination DRQ Type"]
    #[inline(always)]
    pub fn dst_drq_type(&mut self) -> DstDrqTypeW<'_, DdmaCfgReg3Spec> {
        DstDrqTypeW::new(self, 16)
    }
    #[doc = "Bits 21:22 - Destination Address Mode"]
    #[inline(always)]
    pub fn dst_addr_mode(&mut self) -> DstAddrModeW<'_, DdmaCfgReg3Spec> {
        DstAddrModeW::new(self, 21)
    }
    #[doc = "Bit 23 - Destination Burst Length"]
    #[inline(always)]
    pub fn dst_burst_len(&mut self) -> DstBurstLenW<'_, DdmaCfgReg3Spec> {
        DstBurstLenW::new(self, 23)
    }
    #[doc = "Bits 24:25 - Destination Data Width"]
    #[inline(always)]
    pub fn dst_data_width(&mut self) -> DstDataWidthW<'_, DdmaCfgReg3Spec> {
        DstDataWidthW::new(self, 24)
    }
    #[doc = "Bit 26 - Destination INCR8 enable. 0=Single/INCR4, 1=INCR8"]
    #[inline(always)]
    pub fn dst_incr8_en(&mut self) -> DstIncr8EnW<'_, DdmaCfgReg3Spec> {
        DstIncr8EnW::new(self, 26)
    }
    #[doc = "Bit 28 - Memory set mode enable. 0=Disable, 1=Move data from DDMA_GEN_DATA to destination. Source config (bit10-0) invalid when set."]
    #[inline(always)]
    pub fn dma_mem_set_mode(&mut self) -> DmaMemSetModeW<'_, DdmaCfgReg3Spec> {
        DmaMemSetModeW::new(self, 28)
    }
    #[doc = "Bit 29 - DMA Continuous Mode Enable"]
    #[inline(always)]
    pub fn dma_continuous(&mut self) -> DmaContinuousW<'_, DdmaCfgReg3Spec> {
        DmaContinuousW::new(self, 29)
    }
    #[doc = "Bit 31 - DMA Loading"]
    #[inline(always)]
    pub fn dma_loading(&mut self) -> DmaLoadingW<'_, DdmaCfgReg3Spec> {
        DmaLoadingW::new(self, 31)
    }
}
#[doc = "Dedicated DMA Channel 3 Configure Register (supports memory set mode, INCR8)\n\nYou can [`read`](crate::Reg::read) this register and get [`ddma_cfg_reg3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ddma_cfg_reg3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdmaCfgReg3Spec;
impl crate::RegisterSpec for DdmaCfgReg3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddma_cfg_reg3::R`](R) reader structure"]
impl crate::Readable for DdmaCfgReg3Spec {}
#[doc = "`write(|w| ..)` method takes [`ddma_cfg_reg3::W`](W) writer structure"]
impl crate::Writable for DdmaCfgReg3Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DDMA_CFG_REG3 to value 0"]
impl crate::Resettable for DdmaCfgReg3Spec {}
