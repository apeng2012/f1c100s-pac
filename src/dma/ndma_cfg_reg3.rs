#[doc = "Register `NDMA_CFG_REG3` reader"]
pub type R = crate::R<NdmaCfgReg3Spec>;
#[doc = "Register `NDMA_CFG_REG3` writer"]
pub type W = crate::W<NdmaCfgReg3Spec>;
...
impl W {
    #[doc = "Bits 0:4 - Source DRQ Type"]
    #[inline(always)]
    pub fn src_drq_type(&mut self) -> SrcDrqTypeW<'_, NdmaCfgReg3Spec> {
        SrcDrqTypeW::new(self, 0)
    }
    #[doc = "Bits 5:6 - Source Address Type"]
    #[inline(always)]
    pub fn src_addr_type(&mut self) -> SrcAddrTypeW<'_, NdmaCfgReg3Spec> {
        SrcAddrTypeW::new(self, 5)
    }
    #[doc = "Bit 7 - Source Burst Length"]
    #[inline(always)]
    pub fn src_burst_len(&mut self) -> SrcBurstLenW<'_, NdmaCfgReg3Spec> {
        SrcBurstLenW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Source Data Width"]
    #[inline(always)]
    pub fn src_data_width(&mut self) -> SrcDataWidthW<'_, NdmaCfgReg3Spec> {
        SrcDataWidthW::new(self, 8)
    }
    #[doc = "Bit 15 - Remain byte counter read enable"]
    #[inline(always)]
    pub fn remain_byte_read_en(&mut self) -> RemainByteReadEnW<'_, NdmaCfgReg3Spec> {
        RemainByteReadEnW::new(self, 15)
    }
    #[doc = "Bits 16:20 - Destination DRQ Type"]
    #[inline(always)]
    pub fn dst_drq_type(&mut self) -> DstDrqTypeW<'_, NdmaCfgReg3Spec> {
        DstDrqTypeW::new(self, 16)
    }
    #[doc = "Bits 21:22 - Destination Address Type"]
    #[inline(always)]
    pub fn dst_addr_type(&mut self) -> DstAddrTypeW<'_, NdmaCfgReg3Spec> {
        DstAddrTypeW::new(self, 21)
    }
    #[doc = "Bit 23 - Destination Burst Length"]
    #[inline(always)]
    pub fn dst_burst_len(&mut self) -> DstBurstLenW<'_, NdmaCfgReg3Spec> {
        DstBurstLenW::new(self, 23)
    }
    #[doc = "Bits 24:25 - Destination Data Width"]
    #[inline(always)]
    pub fn dst_data_width(&mut self) -> DstDataWidthW<'_, NdmaCfgReg3Spec> {
        DstDataWidthW::new(self, 24)
    }
    #[doc = "Bits 26:28 - DMA Wait State"]
    #[inline(always)]
    pub fn dma_wait_state(&mut self) -> DmaWaitStateW<'_, NdmaCfgReg3Spec> {
        DmaWaitStateW::new(self, 26)
    }
    #[doc = "Bit 29 - DMA Continuous Mode Enable"]
    #[inline(always)]
    pub fn dma_continuous(&mut self) -> DmaContinuousW<'_, NdmaCfgReg3Spec> {
        DmaContinuousW::new(self, 29)
    }
    #[doc = "Bit 31 - DMA Loading"]
    #[inline(always)]
    pub fn dma_loading(&mut self) -> DmaLoadingW<'_, NdmaCfgReg3Spec> {
        DmaLoadingW::new(self, 31)
    }
}
#[doc = "Normal DMA Channel 3 Configure Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ndma_cfg_reg3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ndma_cfg_reg3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct NdmaCfgReg3Spec;
impl crate::RegisterSpec for NdmaCfgReg3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ndma_cfg_reg3::R`](R) reader structure"]
impl crate::Readable for NdmaCfgReg3Spec {}
#[doc = "`write(|w| ..)` method takes [`ndma_cfg_reg3::W`](W) writer structure"]
impl crate::Writable for NdmaCfgReg3Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets NDMA_CFG_REG3 to value 0"]
impl crate::Resettable for NdmaCfgReg3Spec {}
