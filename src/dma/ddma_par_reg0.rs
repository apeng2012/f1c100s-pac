#[doc = "Register `DDMA_PAR_REG0` reader"]
pub type R = crate::R<DdmaParReg0Spec>;
#[doc = "Register `DDMA_PAR_REG0` writer"]
pub type W = crate::W<DdmaParReg0Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Source Comity Counter (value = N+1)"]
    #[inline(always)]
    pub fn src_comity_cnt(&mut self) -> SrcComityCntW<'_, DdmaParReg0Spec> {
        SrcComityCntW::new(self, 0)
    }
    #[doc = "Bits 8:15 - Source Block Counter (value = N+1)"]
    #[inline(always)]
    pub fn src_block_cnt(&mut self) -> SrcBlockCntW<'_, DdmaParReg0Spec> {
        SrcBlockCntW::new(self, 8)
    }
    #[doc = "Bits 16:23 - Destination Comity Counter (value = N+1)"]
    #[inline(always)]
    pub fn dst_comity_cnt(&mut self) -> DstComityCntW<'_, DdmaParReg0Spec> {
        DstComityCntW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Destination Block Counter (value = N+1)"]
    #[inline(always)]
    pub fn dst_block_cnt(&mut self) -> DstBlockCntW<'_, DdmaParReg0Spec> {
        DstBlockCntW::new(self, 24)
    }
}
#[doc = "Dedicated DMA Channel 0 Parameter Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ddma_par_reg0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ddma_par_reg0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdmaParReg0Spec;
impl crate::RegisterSpec for DdmaParReg0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddma_par_reg0::R`](R) reader structure"]
impl crate::Readable for DdmaParReg0Spec {}
#[doc = "`write(|w| ..)` method takes [`ddma_par_reg0::W`](W) writer structure"]
impl crate::Writable for DdmaParReg0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DDMA_PAR_REG0 to value 0"]
impl crate::Resettable for DdmaParReg0Spec {}
