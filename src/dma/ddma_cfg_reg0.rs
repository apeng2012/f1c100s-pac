#[doc = "Register `DDMA_CFG_REG0` reader"]
pub type R = crate::R<DdmaCfgReg0Spec>;
#[doc = "Register `DDMA_CFG_REG0` writer"]
pub type W = crate::W<DdmaCfgReg0Spec>;
#[doc = "Field `SRC_DRQ_TYPE` reader - Source DRQ Type. 0x0=SRAM, 0x1=SDRAM, 0x4=USB, 0x9=AHB_Memory"]
pub type SrcDrqTypeR = crate::FieldReader;
#[doc = "Field `SRC_DRQ_TYPE` writer - Source DRQ Type. 0x0=SRAM, 0x1=SDRAM, 0x4=USB, 0x9=AHB_Memory"]
pub type SrcDrqTypeW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
#[doc = "Field `SRC_ADDR_MODE` reader - Source Address Mode. 00=Linear, 01=IO"]
pub type SrcAddrModeR = crate::FieldReader;
#[doc = "Field `SRC_ADDR_MODE` writer - Source Address Mode. 00=Linear, 01=IO"]
...
#[doc = "Field `SRC_INCR8_EN` reader - Source INCR8 enable (only valid for DDMA3). 0=Single/INCR4, 1=INCR8"]
pub type SrcIncr8EnR = crate::BitReader;
#[doc = "Field `SRC_INCR8_EN` writer - Source INCR8 enable (only valid for DDMA3). 0=Single/INCR4, 1=INCR8"]
...
#[doc = "Field `DST_DRQ_TYPE` reader - Destination DRQ Type. 0x0=SRAM, 0x1=SDRAM, 0x2=LCDC, 0x4=USB, 0x9=AHB_Memory"]
pub type DstDrqTypeR = crate::FieldReader;
#[doc = "Field `DST_DRQ_TYPE` writer - Destination DRQ Type. 0x0=SRAM, 0x1=SDRAM, 0x2=LCDC, 0x4=USB, 0x9=AHB_Memory"]
pub type DstDrqTypeW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
#[doc = "Field `DST_ADDR_MODE` reader - Destination Address Mode. 00=Linear, 01=IO"]
pub type DstAddrModeR = crate::FieldReader;
#[doc = "Field `DST_ADDR_MODE` writer - Destination Address Mode. 00=Linear, 01=IO"]
...
#[doc = "Field `DST_INCR8_EN` reader - Destination INCR8 enable (only valid for DDMA3). 0=Single/INCR4, 1=INCR8"]
pub type DstIncr8EnR = crate::BitReader;
#[doc = "Field `DST_INCR8_EN` writer - Destination INCR8 enable (only valid for DDMA3). 0=Single/INCR4, 1=INCR8"]
...
#[doc = "Field `DMA_LOADING` reader - DMA Loading. Set 1 to start, auto-cleared when finished. Set 0 to stop and reset state machine."]
pub type DmaLoadingR = crate::BitReader;
#[doc = "Field `DMA_LOADING` writer - DMA Loading. Set 1 to start, auto-cleared when finished. Set 0 to stop and reset state machine."]
pub type DmaLoadingW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:4 - Source DRQ Type. 0x0=SRAM, 0x1=SDRAM, 0x4=USB, 0x9=AHB_Memory"]
    #[inline(always)]
    pub fn src_drq_type(&self) -> SrcDrqTypeR {
        SrcDrqTypeR::new((self.bits & 0x1f) as u8)
    }
    #[doc = "Bits 5:6 - Source Address Mode. 00=Linear, 01=IO"]
    #[inline(always)]
    ...
    #[doc = "Bit 10 - Source INCR8 enable (only valid for DDMA3). 0=Single/INCR4, 1=INCR8"]
    #[inline(always)]
    ...
    #[doc = "Bits 16:20 - Destination DRQ Type. 0x0=SRAM, 0x1=SDRAM, 0x2=LCDC, 0x4=USB, 0x9=AHB_Memory"]
    #[inline(always)]
    pub fn dst_drq_type(&self) -> DstDrqTypeR {
        DstDrqTypeR::new(((self.bits >> 16) & 0x1f) as u8)
    }
    #[doc = "Bits 21:22 - Destination Address Mode. 00=Linear, 01=IO"]
    #[inline(always)]
    ...
    #[doc = "Bit 26 - Destination INCR8 enable (only valid for DDMA3). 0=Single/INCR4, 1=INCR8"]
    #[inline(always)]
    ...
    #[doc = "Bit 31 - DMA Loading. Set 1 to start, auto-cleared when finished. Set 0 to stop and reset state machine."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:4 - Source DRQ Type. 0x0=SRAM, 0x1=SDRAM, 0x4=USB, 0x9=AHB_Memory"]
    #[inline(always)]
    pub fn src_drq_type(&mut self) -> SrcDrqTypeW<'_, DdmaCfgReg0Spec> {
        SrcDrqTypeW::new(self, 0)
    }
    #[doc = "Bits 5:6 - Source Address Mode. 00=Linear, 01=IO"]
    #[inline(always)]
    pub fn src_addr_mode(&mut self) -> SrcAddrModeW<'_, DdmaCfgReg0Spec> {
        SrcAddrModeW::new(self, 5)
    }
    #[doc = "Bit 7 - Source Burst Length. 0=1, 1=4"]
    #[inline(always)]
    pub fn src_burst_len(&mut self) -> SrcBurstLenW<'_, DdmaCfgReg0Spec> {
        SrcBurstLenW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Source Data Width. 00=8-bit, 01=16-bit, 10=32-bit"]
    #[inline(always)]
    pub fn src_data_width(&mut self) -> SrcDataWidthW<'_, DdmaCfgReg0Spec> {
        SrcDataWidthW::new(self, 8)
    }
    #[doc = "Bit 10 - Source INCR8 enable (only valid for DDMA3). 0=Single/INCR4, 1=INCR8"]
    #[inline(always)]
    pub fn src_incr8_en(&mut self) -> SrcIncr8EnW<'_, DdmaCfgReg0Spec> {
        SrcIncr8EnW::new(self, 10)
    }
    #[doc = "Bit 15 - Remain byte counter read enable"]
    #[inline(always)]
    pub fn remain_byte_read_en(&mut self) -> RemainByteReadEnW<'_, DdmaCfgReg0Spec> {
        RemainByteReadEnW::new(self, 15)
    }
    #[doc = "Bits 16:20 - Destination DRQ Type. 0x0=SRAM, 0x1=SDRAM, 0x2=LCDC, 0x4=USB, 0x9=AHB_Memory"]
    #[inline(always)]
    pub fn dst_drq_type(&mut self) -> DstDrqTypeW<'_, DdmaCfgReg0Spec> {
        DstDrqTypeW::new(self, 16)
    }
    #[doc = "Bits 21:22 - Destination Address Mode. 00=Linear, 01=IO"]
    #[inline(always)]
    pub fn dst_addr_mode(&mut self) -> DstAddrModeW<'_, DdmaCfgReg0Spec> {
        DstAddrModeW::new(self, 21)
    }
    #[doc = "Bit 23 - Destination Burst Length. 0=1, 1=4"]
    #[inline(always)]
    pub fn dst_burst_len(&mut self) -> DstBurstLenW<'_, DdmaCfgReg0Spec> {
        DstBurstLenW::new(self, 23)
    }
    #[doc = "Bits 24:25 - Destination Data Width. 00=8-bit, 01=16-bit, 10=32-bit"]
    #[inline(always)]
    pub fn dst_data_width(&mut self) -> DstDataWidthW<'_, DdmaCfgReg0Spec> {
        DstDataWidthW::new(self, 24)
    }
    #[doc = "Bit 26 - Destination INCR8 enable (only valid for DDMA3). 0=Single/INCR4, 1=INCR8"]
    #[inline(always)]
    pub fn dst_incr8_en(&mut self) -> DstIncr8EnW<'_, DdmaCfgReg0Spec> {
        DstIncr8EnW::new(self, 26)
    }
    #[doc = "Bit 29 - DMA Continuous Mode Enable. 0=Disable, 1=Enable"]
    #[inline(always)]
    pub fn dma_continuous(&mut self) -> DmaContinuousW<'_, DdmaCfgReg0Spec> {
        DmaContinuousW::new(self, 29)
    }
    #[doc = "Bit 31 - DMA Loading. Set 1 to start, auto-cleared when finished. Set 0 to stop and reset state machine."]
    #[inline(always)]
    pub fn dma_loading(&mut self) -> DmaLoadingW<'_, DdmaCfgReg0Spec> {
        DmaLoadingW::new(self, 31)
    }
}
#[doc = "Dedicated DMA Channel 0 Configure Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ddma_cfg_reg0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ddma_cfg_reg0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DdmaCfgReg0Spec;
impl crate::RegisterSpec for DdmaCfgReg0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddma_cfg_reg0::R`](R) reader structure"]
impl crate::Readable for DdmaCfgReg0Spec {}
#[doc = "`write(|w| ..)` method takes [`ddma_cfg_reg0::W`](W) writer structure"]
impl crate::Writable for DdmaCfgReg0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DDMA_CFG_REG0 to value 0"]
impl crate::Resettable for DdmaCfgReg0Spec {}
