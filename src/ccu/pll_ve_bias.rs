...
pub type R = crate::R<PllVeBiasSpec>;
#[doc = "Register `PLL_VE_BIAS` writer"]
pub type W = crate::W<PllVeBiasSpec>;
...
impl W {
    #[doc = "Bits 0:2 - PLL Damping Factor Control\\[2:0\\]"]
    #[inline(always)]
    pub fn pll_damp_factor_ctrl(&mut self) -> PllDampFactorCtrlW<'_, PllVeBiasSpec> {
        PllDampFactorCtrlW::new(self, 0)
    }
    #[doc = "Bits 16:20 - PLL Bias Control\\[4:0\\]"]
    #[inline(always)]
    pub fn pll_bias_ctrl(&mut self) -> PllBiasCtrlW<'_, PllVeBiasSpec> {
        PllBiasCtrlW::new(self, 16)
    }
    #[doc = "Bits 24:28 - PLL VCO Bias Control\\[4:0\\]"]
    #[inline(always)]
    pub fn pll_vco_bias_ctrl(&mut self) -> PllVcoBiasCtrlW<'_, PllVeBiasSpec> {
        PllVcoBiasCtrlW::new(self, 24)
    }
}
#[doc = "PLL VE Bias Register\n\nYou can [`read`](crate::Reg::read) this register and get [`pll_ve_bias::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pll_ve_bias::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PllVeBiasSpec;
impl crate::RegisterSpec for PllVeBiasSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pll_ve_bias::R`](R) reader structure"]
impl crate::Readable for PllVeBiasSpec {}
#[doc = "`write(|w| ..)` method takes [`pll_ve_bias::W`](W) writer structure"]
impl crate::Writable for PllVeBiasSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PLL_VE_BIAS to value 0x1010_0000"]
impl crate::Resettable for PllVeBiasSpec {
