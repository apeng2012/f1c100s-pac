#[doc = "Register `PLL_VIDEO_PAT_CTRL` reader"]
pub type R = crate::R<PllVideoPatCtrlSpec>;
#[doc = "Register `PLL_VIDEO_PAT_CTRL` writer"]
pub type W = crate::W<PllVideoPatCtrlSpec>;
...
impl W {
    #[doc = "Bits 0:16 - Wave Bottom"]
    #[inline(always)]
    pub fn wave_bot(&mut self) -> WaveBotW<'_, PllVideoPatCtrlSpec> {
        WaveBotW::new(self, 0)
    }
    #[doc = "Bits 17:18 - Frequency: 00=31.5KHz, 01=32KHz, 10=32.5KHz, 11=33KHz"]
    #[inline(always)]
    pub fn freq(&mut self) -> FreqW<'_, PllVideoPatCtrlSpec> {
        FreqW::new(self, 17)
    }
    #[doc = "Bits 20:28 - Wave Step"]
    #[inline(always)]
    pub fn wave_step(&mut self) -> WaveStepW<'_, PllVideoPatCtrlSpec> {
        WaveStepW::new(self, 20)
    }
    #[doc = "Bits 29:30 - Spread Frequency Mode: 00=DC=0, 01=DC=1, 1X=Triangular"]
    #[inline(always)]
    pub fn spr_freq_mode(&mut self) -> SprFreqModeW<'_, PllVideoPatCtrlSpec> {
        SprFreqModeW::new(self, 29)
    }
    #[doc = "Bit 31 - Sigma-Delta Pattern Enable"]
    #[inline(always)]
    pub fn sig_delt_pat_en(&mut self) -> SigDeltPatEnW<'_, PllVideoPatCtrlSpec> {
        SigDeltPatEnW::new(self, 31)
    }
}
#[doc = "PLL Video Pattern Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`pll_video_pat_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pll_video_pat_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PllVideoPatCtrlSpec;
impl crate::RegisterSpec for PllVideoPatCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pll_video_pat_ctrl::R`](R) reader structure"]
impl crate::Readable for PllVideoPatCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`pll_video_pat_ctrl::W`](W) writer structure"]
impl crate::Writable for PllVideoPatCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PLL_VIDEO_PAT_CTRL to value 0"]
impl crate::Resettable for PllVideoPatCtrlSpec {}
