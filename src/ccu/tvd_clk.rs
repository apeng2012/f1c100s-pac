...
pub type R = crate::R<TvdClkSpec>;
#[doc = "Register `TVD_CLK` writer"]
pub type W = crate::W<TvdClkSpec>;
...
#[doc = "Field `CLK_SRC_SEL` reader - Clock Source: 000=PLL_VIDEO(1X), 001=OSC24M, 010=PLL_VIDEO(2X)"]
pub type ClkSrcSelR = crate::FieldReader;
#[doc = "Field `CLK_SRC_SEL` writer - Clock Source: 000=PLL_VIDEO(1X), 001=OSC24M, 010=PLL_VIDEO(2X)"]
...
impl R {
    ...
    #[doc = "Bits 24:26 - Clock Source: 000=PLL_VIDEO(1X), 001=OSC24M, 010=PLL_VIDEO(2X)"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:3 - Clock Divide Ratio M (m+1, divider 1-16)"]
    #[inline(always)]
    pub fn clk_div_ratio_m(&mut self) -> ClkDivRatioMW<'_, TvdClkSpec> {
        ClkDivRatioMW::new(self, 0)
    }
    #[doc = "Bits 24:26 - Clock Source: 000=PLL_VIDEO(1X), 001=OSC24M, 010=PLL_VIDEO(2X)"]
    #[inline(always)]
    pub fn clk_src_sel(&mut self) -> ClkSrcSelW<'_, TvdClkSpec> {
        ClkSrcSelW::new(self, 24)
    }
    #[doc = "Bit 31 - Gating Special Clock"]
    #[inline(always)]
    pub fn sclk_gating(&mut self) -> SclkGatingW<'_, TvdClkSpec> {
        SclkGatingW::new(self, 31)
    }
}
#[doc = "TVD Clock Register\n\nYou can [`read`](crate::Reg::read) this register and get [`tvd_clk::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tvd_clk::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TvdClkSpec;
impl crate::RegisterSpec for TvdClkSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tvd_clk::R`](R) reader structure"]
impl crate::Readable for TvdClkSpec {}
#[doc = "`write(|w| ..)` method takes [`tvd_clk::W`](W) writer structure"]
impl crate::Writable for TvdClkSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TVD_CLK to value 0"]
impl crate::Resettable for TvdClkSpec {}
