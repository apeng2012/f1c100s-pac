#[doc = "Register `SDMMC0_CLK` reader"]
pub type R = crate::R<Sdmmc0ClkSpec>;
#[doc = "Register `SDMMC0_CLK` writer"]
pub type W = crate::W<Sdmmc0ClkSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Clock Divide Ratio M (m+1, divider 1-16)"]
    #[inline(always)]
    pub fn clk_div_ratio_m(&mut self) -> ClkDivRatioMW<'_, Sdmmc0ClkSpec> {
        ClkDivRatioMW::new(self, 0)
    }
    #[doc = "Bits 8:10 - Output Clock Phase Control (0-7)"]
    #[inline(always)]
    pub fn output_clk_phase_ctr(&mut self) -> OutputClkPhaseCtrW<'_, Sdmmc0ClkSpec> {
        OutputClkPhaseCtrW::new(self, 8)
    }
    #[doc = "Bits 16:17 - Clock Pre-Divide Ratio N (2^n, divider 1/2/4/8)"]
    #[inline(always)]
    pub fn clk_div_ratio_n(&mut self) -> ClkDivRatioNW<'_, Sdmmc0ClkSpec> {
        ClkDivRatioNW::new(self, 16)
    }
    #[doc = "Bits 20:22 - Sample Clock Phase Control (0-7)"]
    #[inline(always)]
    pub fn sample_clk_phase_ctr(&mut self) -> SampleClkPhaseCtrW<'_, Sdmmc0ClkSpec> {
        SampleClkPhaseCtrW::new(self, 20)
    }
    #[doc = "Bits 24:25 - Clock Source Select: 00=OSC24M, 01=PLL_PERIPH"]
    #[inline(always)]
    pub fn clk_src_sel(&mut self) -> ClkSrcSelW<'_, Sdmmc0ClkSpec> {
        ClkSrcSelW::new(self, 24)
    }
    #[doc = "Bit 31 - Gating Special Clock"]
    #[inline(always)]
    pub fn sclk_gating(&mut self) -> SclkGatingW<'_, Sdmmc0ClkSpec> {
        SclkGatingW::new(self, 31)
    }
}
#[doc = "SDMMC0 Clock Register\n\nYou can [`read`](crate::Reg::read) this register and get [`sdmmc0_clk::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sdmmc0_clk::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sdmmc0ClkSpec;
impl crate::RegisterSpec for Sdmmc0ClkSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sdmmc0_clk::R`](R) reader structure"]
impl crate::Readable for Sdmmc0ClkSpec {}
#[doc = "`write(|w| ..)` method takes [`sdmmc0_clk::W`](W) writer structure"]
impl crate::Writable for Sdmmc0ClkSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SDMMC0_CLK to value 0"]
impl crate::Resettable for Sdmmc0ClkSpec {}
