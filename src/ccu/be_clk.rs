#[doc = "Register `BE_CLK` reader"]
pub type R = crate::R<BeClkSpec>;
#[doc = "Register `BE_CLK` writer"]
pub type W = crate::W<BeClkSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Clock Divide Ratio M (m+1, divider 1-16)"]
    #[inline(always)]
    pub fn clk_div_ratio_m(&mut self) -> ClkDivRatioMW<'_, BeClkSpec> {
        ClkDivRatioMW::new(self, 0)
    }
    #[doc = "Bits 24:26 - Clock Source: 000=PLL_VIDEO, 010=PLL_PERIPH"]
    #[inline(always)]
    pub fn clk_src_sel(&mut self) -> ClkSrcSelW<'_, BeClkSpec> {
        ClkSrcSelW::new(self, 24)
    }
    #[doc = "Bit 31 - Gating Special Clock"]
    #[inline(always)]
    pub fn sclk_gating(&mut self) -> SclkGatingW<'_, BeClkSpec> {
        SclkGatingW::new(self, 31)
    }
}
#[doc = "BE Clock Register\n\nYou can [`read`](crate::Reg::read) this register and get [`be_clk::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`be_clk::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BeClkSpec;
impl crate::RegisterSpec for BeClkSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`be_clk::R`](R) reader structure"]
impl crate::Readable for BeClkSpec {}
#[doc = "`write(|w| ..)` method takes [`be_clk::W`](W) writer structure"]
impl crate::Writable for BeClkSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BE_CLK to value 0"]
impl crate::Resettable for BeClkSpec {}
