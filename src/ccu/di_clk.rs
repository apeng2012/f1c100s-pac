...
pub type R = crate::R<DiClkSpec>;
#[doc = "Register `DI_CLK` writer"]
pub type W = crate::W<DiClkSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Clock Divide Ratio M (m+1, divider 1-16)"]
    #[inline(always)]
    pub fn clk_div_ratio_m(&mut self) -> ClkDivRatioMW<'_, DiClkSpec> {
        ClkDivRatioMW::new(self, 0)
    }
    #[doc = "Bits 24:26 - Clock Source: 000=PLL_VIDEO(1X), 010=PLL_VIDEO(2X)"]
    #[inline(always)]
    pub fn clk_src_sel(&mut self) -> ClkSrcSelW<'_, DiClkSpec> {
        ClkSrcSelW::new(self, 24)
    }
    #[doc = "Bit 31 - Gating Special Clock"]
    #[inline(always)]
    pub fn sclk_gating(&mut self) -> SclkGatingW<'_, DiClkSpec> {
        SclkGatingW::new(self, 31)
    }
}
#[doc = "De-interlacer Clock Register\n\nYou can [`read`](crate::Reg::read) this register and get [`di_clk::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`di_clk::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DiClkSpec;
impl crate::RegisterSpec for DiClkSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`di_clk::R`](R) reader structure"]
impl crate::Readable for DiClkSpec {}
#[doc = "`write(|w| ..)` method takes [`di_clk::W`](W) writer structure"]
impl crate::Writable for DiClkSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DI_CLK to value 0"]
impl crate::Resettable for DiClkSpec {}
