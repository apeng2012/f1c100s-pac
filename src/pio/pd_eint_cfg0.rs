...
pub type R = crate::R<PdEintCfg0Spec>;
#[doc = "Register `PD_EINT_CFG0` writer"]
pub type W = crate::W<PdEintCfg0Spec>;
...
impl W {
    #[doc = "Bits 0:3 - External INT0 Mode"]
    #[inline(always)]
    pub fn eint0_cfg(&mut self) -> Eint0CfgW<'_, PdEintCfg0Spec> {
        Eint0CfgW::new(self, 0)
    }
    #[doc = "Bits 4:7 - External INT1 Mode"]
    #[inline(always)]
    pub fn eint1_cfg(&mut self) -> Eint1CfgW<'_, PdEintCfg0Spec> {
        Eint1CfgW::new(self, 4)
    }
    #[doc = "Bits 8:11 - External INT2 Mode"]
    #[inline(always)]
    pub fn eint2_cfg(&mut self) -> Eint2CfgW<'_, PdEintCfg0Spec> {
        Eint2CfgW::new(self, 8)
    }
    #[doc = "Bits 12:15 - External INT3 Mode"]
    #[inline(always)]
    pub fn eint3_cfg(&mut self) -> Eint3CfgW<'_, PdEintCfg0Spec> {
        Eint3CfgW::new(self, 12)
    }
    #[doc = "Bits 16:19 - External INT4 Mode"]
    #[inline(always)]
    pub fn eint4_cfg(&mut self) -> Eint4CfgW<'_, PdEintCfg0Spec> {
        Eint4CfgW::new(self, 16)
    }
    #[doc = "Bits 20:23 - External INT5 Mode"]
    #[inline(always)]
    pub fn eint5_cfg(&mut self) -> Eint5CfgW<'_, PdEintCfg0Spec> {
        Eint5CfgW::new(self, 20)
    }
    #[doc = "Bits 24:27 - External INT6 Mode"]
    #[inline(always)]
    pub fn eint6_cfg(&mut self) -> Eint6CfgW<'_, PdEintCfg0Spec> {
        Eint6CfgW::new(self, 24)
    }
    #[doc = "Bits 28:31 - External INT7 Mode"]
    #[inline(always)]
    pub fn eint7_cfg(&mut self) -> Eint7CfgW<'_, PdEintCfg0Spec> {
        Eint7CfgW::new(self, 28)
    }
}
#[doc = "PD External Interrupt Configure Register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`pd_eint_cfg0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pd_eint_cfg0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PdEintCfg0Spec;
impl crate::RegisterSpec for PdEintCfg0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pd_eint_cfg0::R`](R) reader structure"]
impl crate::Readable for PdEintCfg0Spec {}
#[doc = "`write(|w| ..)` method takes [`pd_eint_cfg0::W`](W) writer structure"]
impl crate::Writable for PdEintCfg0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PD_EINT_CFG0 to value 0"]
impl crate::Resettable for PdEintCfg0Spec {}
