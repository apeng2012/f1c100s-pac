...
pub type R = crate::R<PdEintDebSpec>;
#[doc = "Register `PD_EINT_DEB` writer"]
pub type W = crate::W<PdEintDebSpec>;
...
impl W {
    #[doc = "Bit 0 - Debounce Clock Select (0: LOSC, 1: HOSC)"]
    #[inline(always)]
    pub fn deb_clk_sel(&mut self) -> DebClkSelW<'_, PdEintDebSpec> {
        DebClkSelW::new(self, 0)
    }
    #[doc = "Bits 4:6 - Debounce Clock Prescale"]
    #[inline(always)]
    pub fn deb_clk_pre(&mut self) -> DebClkPreW<'_, PdEintDebSpec> {
        DebClkPreW::new(self, 4)
    }
}
#[doc = "PD External Interrupt Debounce Register\n\nYou can [`read`](crate::Reg::read) this register and get [`pd_eint_deb::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pd_eint_deb::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PdEintDebSpec;
impl crate::RegisterSpec for PdEintDebSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pd_eint_deb::R`](R) reader structure"]
impl crate::Readable for PdEintDebSpec {}
#[doc = "`write(|w| ..)` method takes [`pd_eint_deb::W`](W) writer structure"]
impl crate::Writable for PdEintDebSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PD_EINT_DEB to value 0"]
impl crate::Resettable for PdEintDebSpec {}
